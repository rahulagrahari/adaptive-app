...
public class MainQuestionServices {
    ...
    public List<Problem> getFirstProblem(String params) {
        ...
        mainQuestionRepo.findByLevelAndTopic(1,score).forEach(prob->p.add((Problem) prob));
    ...
    public List<Problem> getProblem(String params) {
        ...
        List<Problem> p = new ArrayList<>();
        if (score==0){
            mainQuestionRepo.findByLevelAndTopic(score-1, topic).forEach(prob->p.add((Problem) prob));
        }
